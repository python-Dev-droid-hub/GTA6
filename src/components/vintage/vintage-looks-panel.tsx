...
import type { VintageLooksPanel } from "@/data/vintage-city-park";
import { VintageExpandButton } from "./vintage-expand-button";

/**
 * Third chapter — 50/50: Looks plate | white Outfits & Hairstyles copy.
 */
export function VintageLooksPanelView({
  panel,
  onExpand,
}: {
  panel: VintageLooksPanel;
